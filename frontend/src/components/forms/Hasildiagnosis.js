    ...
    >
      {({ values }) => (
        <Form className='space-y-4 w-full'>
          ...
          <div>
            <label htmlFor="icd10" className='block text-sm font-medium leading-6 text-gray-900'>ICD-10</label>
            <div className="mt-2">
              <Field as="textarea" id="icd10" name="icd10" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
            <ErrorMessage className='block text-sm font-medium text-red-600' name="icd10" component="div" />
          </div>
